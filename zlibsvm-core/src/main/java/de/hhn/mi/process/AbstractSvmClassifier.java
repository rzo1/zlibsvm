...
/**
 * Abstract base for SVM classifiers. Handles the conversion of a trained {@link SvmModel}
 * into the native LIBSVM {@link svm_model} used during prediction.
 */
abstract class AbstractSvmClassifier extends AbstractSvmTool implements SvmClassifier {
    ...
    /**
     * Converts a high-level {@link SvmModel} into a native LIBSVM {@link svm_model}.
     */
