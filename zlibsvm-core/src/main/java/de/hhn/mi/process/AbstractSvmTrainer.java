...
public abstract class AbstractSvmTrainer extends AbstractSvmTool implements SvmTrainer {
    ...
    /**
     * @param svmConfiguration must not be <code>null</code>       .
     * @param modelName
     ...
     *
     * @throws de.hhn.mi.exception.ClassificationCoreException if a nu-svc in the given configuration is infeasible or one-class SVM probability output was specified.
     */
