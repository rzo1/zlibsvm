...
/**
 * Immutable record implementation of {@link SvmClassLabel}.
 *
 * @param numeric     the numeric class identifier
 * @param name        a human-readable name for this label
 * @param probability the probability estimate (or 1.0 if not applicable)
 */
